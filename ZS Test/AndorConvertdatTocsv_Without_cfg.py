...
#Input .dat file
filename = r"C:\Users\Sommer Lab\Documents\Data\2022\01 Jan 2022\25 Jan\scan21.dat"
...
plt.show()
plt.figure()
plt.imshow(images[PreviewIndex,ymin:ymax,xmin:xmax],cmap="gray", origin="lower",interpolation="nearest",vmin=150,vmax=5000)
plt.show()
