...
####################################
date = '9/15/2023'
data_folder = r'/FLIR/MOT Movement'
...
#Parameter Setting
####################################
examNum = 21 #The number of runs to exam.
examFrom = None#Set to None if you want to check the last several runs. 
do_plot = True

variablesToDisplay = None
variablesToDisplay = ['FLIR Pulse']
...
ImageAnalysisCode.ShowImagesTranspose(images_array, logTime, variableLog, 
                                      variablesToDisplay, variableFilterList, showTimestamp=1)
